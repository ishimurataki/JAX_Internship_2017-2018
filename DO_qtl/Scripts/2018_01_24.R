#############################################################
# Redoing the QTL maps of the insulin secretion traits
# January 24th, 2018
# - Taki Ishimura
#############################################################
library(ggplot2)
...
saveRDS(out, "Derived_data/2018_01_24_ins_output.rds")


# print QTL plots
pdf(file = "Plots/2018_01_24/ins_sec_qtl.pdf", width = 8, height = 4)
for(i in 1:ncol(out)){
